...
namespace Managment_System_Ptoject
{
    ...
    {
        public MaintenanceEmployee(string firstName, string lastName, double salary,
                                   ...
                                   int hoursPerDay, string address, ImageWithTag mntImg)
        {
            ...
            this._gender = gender;
            this._mail = mail;
            this._workerImg = mntImg;
        }
        public override double getSalary() { return this._salary * 0.80; }
    }
}
